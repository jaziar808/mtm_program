...
def read_from_port(port:str)->bytes:
    ...
    :return: a string of characters, in the order recieved, that represent the bytes from the serial port
    """
    # TODO
    return ""
...
def write_to_port(port:str, data:bytes):
    ...
    :param data: sequence of characters to write to the port
    :return: none
    """
    # TODO
    return